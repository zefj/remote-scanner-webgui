...
def scan_view():
    ...
    if request.method == 'POST':
        ...
        scanner = [device for device in devices if device.name in device_choice][0]  # bleh, I hate the way pyinsane returns available devices
        ...
        temp_filename = temp_name_handler(format)
